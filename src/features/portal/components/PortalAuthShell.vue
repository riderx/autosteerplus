    ...
    >
      ...
      >
        <div class="grid gap-3">
          ...
          <p
            class="m-0 max-w-2xl text-[1rem] leading-[1.55] text-[rgba(60,60,67,0.82)]"
          >
            Sign in to access firmware installs, device controls, and update
            guidance for your approved hardware.
          </p>
        </div>
        <p
          id="login-feedback"
          class="mt-4 rounded-[18px] border border-[rgba(255,59,48,0.18)] bg-[rgba(255,59,48,0.08)] px-4 py-3 text-[0.95rem] font-medium leading-[1.5] text-[#b42318]"
          :hidden="portalView.loginFeedback === ''"
        >
        ...
        >
          ...
          <div class="grid gap-3">
            ...
            >
              <p
                id="auth-note"
                class="m-0 text-[0.98rem] leading-[1.55] text-[rgba(60,60,67,0.82)]"
              >
                {{ portalView.authNote }}
              </p>
            </div>
          ...
          <div
            id="login-challenge-shell"
            class="min-h-[4.25rem]"
            :hidden="!portalView.loginChallengeVisible"
          >
            <div id="login-challenge-widget"></div>
          </div>
          <p
            id="login-challenge-note"
            class="text-[0.98rem] leading-[1.55] text-[rgba(60,60,67,0.82)]"
            :hidden="!portalView.loginChallengeVisible"
          >
      ...
      <div class="flex flex-wrap items-center gap-3 px-1">
        <PortalActionButton
          variant="ghost"
          @click="portalActions.openOnboarding()"
        >
          Start Onboarding
        </PortalActionButton>
